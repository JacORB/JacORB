  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      if (selectorManager == null) {
        System.out.println ("SelectorManager not initialized. Are you sure you have enabled non-blocking connections?");
        return;
      }

      // request a callback
      SelectorRequest selectorRequest = new SelectorRequest (new TimerCallback(), System.nanoTime() + requestDuration * 1000000);
      ...
      System.out.println ("Halting the SelectorManager");
