...
public class MiscTest extends TestCase
{
	...
	{
		TestSuite suite = new TestSuite ("Miscellaneous ORB Tests");
		
		suite.addTest (new MiscTest ("test_Any_byte_array_1"));
		suite.addTest (new MiscTest ("test_Any_byte_array_3999"));
		suite.addTest (new MiscTest ("test_Any_byte_array_4000"));
		suite.addTest (new MiscTest ("test_Any_byte_array_4001"));
		suite.addTest (new MiscTest ("test_Any_byte_array_40123"));
