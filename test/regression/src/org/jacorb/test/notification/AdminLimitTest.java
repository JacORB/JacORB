...
public class AdminLimitTest extends TestCase {
	...
	consumerAdmin_ = new ConsumerAdminTieImpl(appContext_, channelContext_, _adminProps, _qosProps);
	events_ = new Vector();
    }
	...
	assertEquals(consumerAdmin_, ((FrameworkEvent)events_.get(0)).getSource());
    }
