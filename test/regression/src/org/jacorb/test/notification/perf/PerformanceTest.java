...
public class PerformanceTest extends NotificationTestCase
{
    ...
    public void measureFilterLatency(String filterString, StructuredEvent event, int runs)
            throws Exception
    {
    ...
    public void measureLatencyPushPushMultipleFilter(int numberOfConsumers, int events)
            throws Exception
    {
        System.out.println("\n");
        ...
        StructuredPushSender _sender = new StructuredPushSender(this, _perfLogger, _generator,
                events, sInterval);
        ...
        System.out
                .println("Average per Event: " + ((System.currentTimeMillis() - _start) / events));
    }

    public void measureLatencyPushPushFilter(int numberOfSuppliers, int numberOfConsumers,
            int events) throws Exception
    {
        ...
        AnyPushSender _sender = new AnyPushSender(this, _perfLogger, _generator, events, sInterval);
    ...
    public void measureLatencyPushPush(int numberOfSuppliers, int numberOfConsumers,
            int numberOfevents, boolean checkAssertions, boolean latexTable) throws Exception
    {
        System.out.println("Mesure Latency Push Push");
        ...
        {
            _barrier = new CyclicBarrier(numberOfConsumers);
        ...
        for (int x = 0; x < _receivers.length; x++)
        {
            _receivers[x] = new AnyPushReceiver(this, _perfLogger, numberOfevents
                    * numberOfSuppliers);
            _receivers[x].connect(channel_, false);
    ...
    public void testMeasureLatencyEcho() throws Exception
    {
        ...
        EchoServer _echoServer = EchoServerHelper.narrow(getORB().resolve_initial_references(
                "EchoServer"));
    ...
    {
        EchoServer server = EchoServerHelper.narrow(getORB().resolve_initial_references(
                "EchoServer"));
    ...
    public void measureLatencyEcho(TestEventGenerator gen, EchoServer server, int runs)
            throws Exception
    {
    ...
    public void measureBurstSend(int events, int numberOfConsumers) throws Exception
    {
        ...
        System.out.println("Send Burst: " + events + " Events to " + numberOfConsumers
                + " Consumers");
        ...
        AnyPushSender _sender = new AnyPushSender(this, _logger, _generator, events, 0);
    ...
    public void _testLoop() throws Exception
    {
        while (true)
        {
            measureLatencyPushPush(2, 2, 20000, true, false);
    ...
    public static Test suite() throws Exception
    {
        ...
        NotificationTestCaseSetup setup = new NotificationTestCaseSetup(_suite);
        ...
        // _suite.addTest(new PerformanceTest("testMeasureFilterLatency",
        // setup));
        // _suite.addTest(new PerformanceTest("testLatencyPushPushWithFilter",
        // setup));

        // _suite.addTest(new
        // PerformanceTest("testLatencyPushPushMultipleFilter", setup));
...
class SendCounter implements PerformanceListener
{
    ...
    {
        return received_ + " & " + (int) ((double) received_ / senderSum_ * 1000) + " & "
