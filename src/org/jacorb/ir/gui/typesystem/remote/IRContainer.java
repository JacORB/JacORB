 ...
 * Neben den "echten" CORBA-Container-Klassen soll das z.B. auch StructDef sein.
 * Letztere Klassen sollen also bei uns konzeptionell Container sein, weil sie member
 * besitzen (auch wenn sie nicht von CORBA::Container erben)
 * 
 */
    ...
    implements AbstractContainer
{
    ...
    */
    ...
    {
	Container container = ContainerHelper.narrow((org.omg.CORBA.Object)this.irObject);
	Contained[] contents = container.contents(DefinitionKind.dk_all, true);	
