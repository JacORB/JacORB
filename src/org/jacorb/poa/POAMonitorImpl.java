 ...
 */
public class POAMonitorImpl extends POAAdapter implements POAMonitor, LogTrace, POAMonitorController {
	...
	public synchronized void closeMonitor() {
		if (view != null) {			
			try {
				...
				POAMonitor newMonitor = (POAMonitor)Class.forName("jacorb.poa.POAMonitorLightImpl").newInstance();
