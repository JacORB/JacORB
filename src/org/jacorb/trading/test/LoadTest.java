...
public class LoadTest {
	...
	System.exit(0);
	    ...
	    new OutputForwarder(_rt.exec("trader " + args[0] + "1 -d db1"), "Trader1");
	    new OutputForwarder(_rt.exec("trader " + args[0] + "2 -d db2"), "Trader2");
	    new OutputForwarder(_rt.exec("trader " + args[0] + "3 -d db3"), "Trader3");
	    new OutputForwarder(_rt.exec("trader " + args[0] + "4 -d db4"), "Trader4");
