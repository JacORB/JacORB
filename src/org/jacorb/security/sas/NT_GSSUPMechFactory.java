...
public final class NT_GSSUPMechFactory implements MechanismFactory
{
    ...
    public GSSContextSpi getMechanismContext(GSSNameSpi nameSpi, GSSCredentialSpi credSpi, int lifetime) throws GSSException
    {
	  ...
	  return new NT_GSSUPContextSpi(myProvider, myMechOid, nameSpi, credSpi, lifetime);
    }
    ...
    public GSSContextSpi getMechanismContext(GSSCredentialSpi credSpi) throws GSSException
    {
	  ...
	  return new NT_GSSUPContextSpi(credSpi.getProvider(), credSpi.getMechanism(), credSpi.getName(), credSpi, credSpi.getInitLifetime());
    }
