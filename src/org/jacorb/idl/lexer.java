 ...
 *  IDL. It is adapted from one the Java_CUP lexer. 
 *  
 *  The scanner reads characters from a global input stream and returns 
 *  integers corresponding to the terminal number of the next token.  
 *  Once the end of input is reached the EOF token is returned on every 
 *  subsequent call.<p>
 ...
 *
 *  Also, this class provides basic preprocessing facilties, i.e. it does
 *  handle preprocessor directives such as #define, #undef, #include, etc.
 *  although it does not provide full C++ preprocessing
 *  
...
public class lexer 
{
    ...
    public static String checkIdentifier( String str )
    {
        ...
        {
            emit_error("Identifier " + str + " collides with keyword " + colliding_keyword + ".");
            return null;
        }
    ...
    /**
     * Only the most general name clasehs with Java keywords
        ...
        throws java.io.IOException
    {
        ...
        for (;;)
        {
            ...
            {    
                ...
                {                   
                    advance();
                    token t = new char_token(sym.CH,(char)next_char);
                    advance();
                    if( (char)next_char == '\'' )
                    {               
