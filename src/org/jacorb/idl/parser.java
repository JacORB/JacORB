...
public class parser extends java_cup.runtime.lr_parser {
  ...
  public java_cup.runtime.token scan()
    ...
    public static void usage(String [] argv, String msg)
    {
        ...
        System.out.println("Usage: idl [-h|-help][-v|-version][-syntax][-all][-Idir][-Dsymbol[=value]][-U <symbol>][-noskel][-nostub][-nofinal][-ir][-sloppy_names][-sloppy_forward][-i2jpackage x:y][-d <Output Dir>][-p <package_prefix>][-i <import_package][-W debug_level][-global_import] <filelist>");
        System.exit(1);
    }
