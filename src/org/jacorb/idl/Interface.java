...
{ 
    ...
    private void printInterface(String classname, PrintWriter ps)
    {
        ...
        ps.println("/**");
        ps.println(" * Generated by the JacORB IDL compiler.");
        ps.println(" */");
    ...
    /**
     *  generate XML description for Interface Repository
     */

//      private void printInterfaceXML(String classname, PrintWriter ps)
//      {
//          ps.println("<!-- " + "Generated by the JacORB IDL compiler. -->");
...
//              {
//                  ps.println( indentString(scopes)  + "<module name=\"" +  ((Module)enc).name + "\">");
//                  modules++;
//                  scopes++;
//              }
...
//          ps.println( indentString(scopes) + "<interface name=" + classname + "\">");
//          scopes++;
...
//              for(; e.hasMoreElements();)
//              {
//                  ps.println( indentString(scopes) + "<inherits name=\"" + ((ScopedName)e.nextElement()).IDLName() + "\"/>");
//              }
//          }
...
//              // forward declaration
//              body.printConstants(ps);
//              body.printOperationXML(ps);
//          }
//          ps.println(indentString(--scopes) +  "</interface>");

//          for( int i = 0; i < modules; i++ )
//          {
//              ps.println( indentString(--scopes) + "</module>");
//          }
//      }
...
//      ps.println("\t}");
    ...
    private void printIRHelper( String className, PrintWriter ps )
    {
        ...
        ps.println("\n/**");
        ps.println(" * DO NOT EDIT. This class contains Interface Repository ");
        ps.println(" * information generated by the JacORB IDL compiler.");
        ps.println(" */");
