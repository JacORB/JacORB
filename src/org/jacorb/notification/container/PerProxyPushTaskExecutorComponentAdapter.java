...
public class PerProxyPushTaskExecutorComponentAdapter extends AbstractComponentAdapter
{
    public PerProxyPushTaskExecutorComponentAdapter()
    {
    ...
    {
        TaskExecutor executor = new DefaultTaskExecutor("PerProxyDeliverThread", 1);
