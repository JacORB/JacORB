...
$TAO_ROOT/orbsvcs/ImplRepo_Service/${APP} \
 update JACORB:${implName}/${poaName} \
 -a NORMAL \
 ...
 -r 3 \
 -l ${host} \
 -c "/usr/bin/java -Djava.endorsed.dirs=${JACORB_HOME}/lib -Djacorb.home=${JACORB_HOME} -Dorg.omg.CORBA.ORBClass=org.jacorb.orb.ORB -Dorg.omg.CORBA.ORBSingletonClass=org.jacorb.orb.ORBSingleton -classpath :${JACORB_HOME}/classes:${JACORB_HOME}/demo/tao_imr/build/classes demo.tao_imr.Server_1 server.ior 60"
