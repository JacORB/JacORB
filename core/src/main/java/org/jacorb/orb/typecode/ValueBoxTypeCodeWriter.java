 ...
 */
public class ValueBoxTypeCodeWriter extends ComplexTypeCodeWriter
{
                                                                       ...
                                                                       Bounds
    {
        ...
        out.write_TypeCode( typeCode.content_type(), recursiveTCMap, repeatedTCMap);
    }

    public TCKind[] getSupportedTypeCodes()
    {
        return new TCKind[] {TCKind.tk_value_box};
    }
}
