...
\subsubsection{Compacting Typecodes}
\label{compact-typecode}
Using the proprty
\begin{verbatim}
jacorb.compactTypecodes=off
...
based transports. & boolean & off. Note that this feature is currently only
for client-side connections, and only for plain IIOP - not SSL. There is no
technical reason for these restrictions, simply lack of current need. \\
\hline
...
and an exception is raised to the client application. \\
\hline
