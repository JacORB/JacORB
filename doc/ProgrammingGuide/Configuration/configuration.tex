...
\hline
\verb"jacorb.use_tao_imr" & Switch on to contact the TAO Implementation Repository (TAO ImR) on every server start-up. Default is off.  This property must be turned off when the “jacorb.use_imr” is turned on.   If both properties are turned on, an exception will be thrown. & boolean \\
\hline
