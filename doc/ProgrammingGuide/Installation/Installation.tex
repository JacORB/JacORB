...
\textbf{Note:} The JacORB Core module utilises Endorsed Directories to build in the maven-compiler-plugin. In Eclipse, the JBoss Tools Endorsed Libraries support is required for this to work.
