...
Setting up BiDirectional GIOP consists of two parts:
\begin{enumerate}
\item Setting an ORBInitializer property.
\item Creating the BiDir policy
\item Adding this policy to the servants POA.
\end{enumerate}
