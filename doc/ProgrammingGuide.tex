...
\noindent{\tt idl
  ...
  [-d <Output Dir>] [-i <import\_package] [-i2jpackage x:y]
  [-i2jpackagefile <filename>] [-ir] [-nofinal] [-noskel] [-nostub]
  [-p <package\_prefix>] [-sloppy\_forward] [-sloppy\_names] [-syntax]
  <filelist>}
...
The {\tt -i} option allows you to add the specified Java import to the
 generated code.
