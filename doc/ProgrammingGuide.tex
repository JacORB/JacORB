...
of a client calling direct to a server it calls to the Appligator
...
\verb"directly be established. Default is 5." & integer \\
\hline
\verb"jacorb.retry_interval" & \verb"Time in milliseconds to wait between"
\verb"retries. Default is 500." & millisec. \\
\hline
...
\verb"milliseconds. Not set by default." & millisec. \\
\hline
...
\verb"nothing happens. Not set by default." & millisec. \\
\hline
\verb"jacorb.reference_cachi"
\verb"ng" & \verb"Whether or not JacORB caches objects"
\verb"references. Not set by default." & boolean \\
\hline
...
\verb"GIOP. Not set by default." & class \\
\hline
...
\verb"off. Default is off." & boolean \\
\hline
\verb"org.omg.PortableInterc"
\verb"eptor.ORBInitializerCl"
