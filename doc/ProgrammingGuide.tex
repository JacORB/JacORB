...
somewhere.  This will result  in a new directory {\tt JacORB1\_3\_30}.
Make   sure  your   CLASSPATH  environment   variable   contains  {\tt
JacORB1\_3\_30/lib/jacorb.jar}.  If you plan to recompile all or parts
of  JacORB,  you  should  also include  {\tt  JacORB1\_3\_30/classes}.
Extend  your search path  with {\tt  JacORB1\_3\_30/bin}, so  that the
