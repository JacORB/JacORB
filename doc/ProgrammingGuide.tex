...
\begin{figure}[htb]
  \begin{center}
    \includegraphics[width=11cm]{Nmgr1}
  \end{center}
...
\begin{figure}[htb]
  \begin{center}
    \includegraphics[width=11cm, angle=270]{IRBrowser}
\end{center}
...
\hline
\verb"jacorb.imr.timeout" & Time in milliseconds that the implementation will wait for a started server to register. After this timeout is exceeded the IR assumes the server has failed to start. Default is 2000 (2 seconds). & millisec. \\
\hline
